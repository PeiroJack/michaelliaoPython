...
# 1.定义两个Queue队列，一个用于发送任务，一个用于接收结果
...
# 2.把上面创建的两个队列注册在网络上，利用register方法
# 第一个参数是注册在网络上队列的名称
# callable参数关联Queue对象，将Queue对象在网络中暴露
